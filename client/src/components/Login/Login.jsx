  ...
  return (
    <div className='min-h-screen flex flex-col justify-center items-center '>
        <div className="p-5 bg-[rgba(0,0,0,0.3)] backdrop-blur-sm w-120 flex flex-col justify-center rounded-xl border gap-7">
            <form onSubmit={(e)=>{ e.preventDefault(); params.handleLogin() }} ref={params.loginRef}>
            ...
            <button type='submit' className='bg-gray-50 p-2 w-full rounded hover:cursor-pointer hover:scale-103 active:scale-96 hover:bg-gray-300 border' style={{transition:"all 100ms"}}>Login</button>
            </form>
            <button onClick={()=>{params.setReg(true)}} className='text-gray-300 hover:cursor-pointer'>Don't have an account? <span className='text-white underline underline-offset-2'>Register</span></button>
        </div>
    </div>
