  ...
  return (
    <div className='min-h-screen flex flex-col justify-center items-center '>
        <div className="p-5 bg-[rgba(0,0,0,0.3)] backdrop-blur-sm w-120 flex flex-col justify-center h-auto rounded-xl border gap-7">
            <form action={()=>{console.log(params.regRef.current[0].value,params.regRef.current[1].value)}} ref={params.regRef} className='flex flex-col gap-7 items-center justify-center '>
